...
import { bsc, bscTest, baseGoerli, goerli } from '@pancakeswap/wagmi/chains'
...
const CHAINS = process.env.NEXT_PUBLIC_NODE_ENV === 'production' ? [bsc, goerli] : [bscTest, goerli, baseGoerli]
